...
export const Sidebar = () => {
  return <aside className="bg-white text-black botder-r border-gray-100 w-[280px] min-h-screen hidden lg:block">
...
const Navlink =({path, link}: {
    ...
    return (
        <li key={link.label}>
            <Link href={link.href} target={link.target} className={cn(
                "group flex h-9 items-center gap-x-3 rounded-md px-3 text-sm font-semibold leda text-black",
